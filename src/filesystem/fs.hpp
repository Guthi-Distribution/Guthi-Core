...
namespace FileSystem
{
	...
	struct FileCache {
		...
		struct Caches {
			...
			std::unordered_map<std::string, FileCacheEntry> OnRAMCached;
			std::unordered_map<std::string, FileCacheEntry> OnDiskCached;
		} caches;
		...
		FileCacheEntry* GetCachedFile(std::string_view file);
